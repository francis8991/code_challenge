...
function prevent_default<T extends App.Fn>(fn: T): T {
...
function stop_propagation<T extends App.Fn>(fn: T): T {
  return function (event: Event) {
...
function stop_immediate_propagation<T extends App.Fn>(fn: T): T {
  return function (event: Event) {
...
function self_event<T extends App.Fn>(
...
function trusted_event<T extends App.Fn>(fn: T): T {
  return function (event: Event) {
    if (!event.isTrusted) {
      return;
    }
